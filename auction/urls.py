...
urlpatterns = patterns('',
    ...
    #url(r'^item/(?P<id>\d+)/begin$', views.AuctionView.begin, name='begin'),
    url(r'^item/(?P<id>\d+)$', views.get_details, name='item_detail'),
    #url(r'^item/(?P<id>\d+)/update$', views.AuctionView.update, name='update'),
    #url(r'^item/(?P<id>\d+)/end$', views.AuctionView.end, name='end'),
